...
namespace StudentMauiApp.Views;
...
public class AddStudent : ContentPage
{
	...
	{
        Title = "AddStudent";
        Student user = OurStudent.student2;
        ...
        Entry Efirst = new Entry
        {
            ...
            Placeholder = Student.FirstNamePlacehr,
            MaxLength = 15,
        ...
        Entry Elast = new Entry
        {
            ...
            Placeholder =Student.LastNamePlacehr,
            MaxLength = 18,
            Keyboard = Keyboard.Text
        };
      ...
      datePicker.Date == DateTime.Today)
            ...
            //await AddStudentAndNavigate(newStudent);
